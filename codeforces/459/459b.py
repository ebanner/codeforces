if __name__ == '__main__':
    ...
    min_beauties = len([1 for beauty in beauties if beauty == min_beauty])
    max_beauties = len([1 for beauty in beauties if beauty == max_beauty])

    if min_beauty == max_beauty:
        combs = min_beauties*(min_beauties-1)
    else:
